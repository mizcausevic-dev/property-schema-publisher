...
### Released
- Released **property-schema-publisher** publicly as a reviewable operating system for answer-engine visibility.
...
### Shipped
- Cut the first coherent internal version of **property-schema-publisher** with stable domain objects, review surfaces, and decision outputs.
